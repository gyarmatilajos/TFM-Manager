...
{
    public class PartnerContactDocument : IEntityTypeConfiguration<PartnerContactDocument>
    {
        public int Id { get; set; }

        public int PartnerContactId { get; set; }
        public PartnerContact PartnerContact { get; set; } = null!;
        ...
        public void Configure(EntityTypeBuilder<PartnerContactDocument> builder)
        {
            builder.HasKey(x => x.Id);

            builder.Property(x => x.PartnerContactId)
                .IsRequired();
            ...
            builder.HasOne(x => x.PartnerContact)
                .WithMany(x => x.Documents)
                .HasForeignKey(x => x.PartnerContactId)
            ...
            builder.HasIndex(x => x.PartnerContactId);
