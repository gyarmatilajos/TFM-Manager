...
{
    public class PartnerLocationDocument : IEntityTypeConfiguration<PartnerLocationDocument>
    {
        public int Id { get; set; }

        public int PartnerLocationId { get; set; }
        public PartnerLocation PartnerLocation { get; set; } = null!;
        ...
        public void Configure(EntityTypeBuilder<PartnerLocationDocument> builder)
        {
            builder.HasKey(x => x.Id);

            builder.Property(x => x.PartnerLocationId)
                .IsRequired();
            ...
            builder.HasOne(x => x.PartnerLocation)
                .WithMany(x => x.Documents)
                .HasForeignKey(x => x.PartnerLocationId)
            ...
            builder.HasIndex(x => x.PartnerLocationId);
